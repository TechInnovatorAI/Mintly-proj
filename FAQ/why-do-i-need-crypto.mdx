---
title: 'Why Crypto?' 
description: 'Why Polymarket uses crypto and blockchain technology to create the world’s largest Prediction market.'
---

Polymarket operates on Polygon, a proof-of-stake layer two blockchain built on [Ethereum](Ethereum.org). All transactions are denominated in USDC, a US-dollar pegged stablecoin.
