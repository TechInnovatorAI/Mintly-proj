...
The order book displays all the resting orders available on the market.

In our previous tutorial on [Making your First Trade](/trading/making-your-first-trade), we learned about market orders. In a market order, your trade executes instantly at the current market price.
...
ℹ️ Note that it’s not necessary for the entire order to execute at once. Limit orders can ‘partially fill’ as individual traders fill parts of your order.
