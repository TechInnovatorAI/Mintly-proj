...
<img className="block h-32 dark:hidden" src="https://polymarket-upload.s3.us-east-2.amazonaws.com/Orderbook-light.png" />
<img className="hidden h-32 dark:block" src="https://polymarket-upload.s3.us-east-2.amazonaws.com/Orderbook-dark.png" />
