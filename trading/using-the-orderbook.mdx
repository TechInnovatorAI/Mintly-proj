...
{/* For Light Mode */}
<img height="2000" className="block h-32 dark:hidden" noZoom src="https://polymarket-upload.s3.us-east-2.amazonaws.com/Orderbook-light.png" />

{/* For Dark Mode */}
<img height="2000" className="hidden h-32 dark:block" noZoom src="https://polymarket-upload.s3.us-east-2.amazonaws.com/Orderbook-dark.png" />



In this market, “Who will win the US 2024 Presidential Election”, we are viewing the order book for Trump “Yes” shares.
